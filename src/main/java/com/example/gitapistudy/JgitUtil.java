...
public class JgitUtil {
    ...
    private static String userId = "mlulucky";
    private static String userPass = "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";
    private static String userName = "mlulucky";
    private static String userEmail = "dmswjdans@gmail.com";
    private static String hash = "origin/main";
    private static String url = "https://github.com/mlulucky/gitAPIStudy.git";
